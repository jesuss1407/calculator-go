...
// Sends one calculation to the backend and returns the result. Leave b out for sqrt:
// JSON.stringify drops undefined fields, so the request then has no b at all.
